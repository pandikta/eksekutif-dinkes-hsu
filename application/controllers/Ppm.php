...
class Ppm extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Masukkan data Promosi dan Pemberdayaan Masyarakat';
            $this->load->view('templates/header', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('ppm/index');
            ...
            redirect('ppm'); //lari ke folder menu lalu ke file submenu yg ada di views
    ...
    {
        $tahun = $this->input->post('tahun');
        $this->db->delete('ppm', ['tahun' => $tahun]);
    ...
    public function table()
    {
        ...
        $data['title'] = 'Data Promosi dan Pemberdayaan Masyarakat';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('ppm/table');
        $this->load->view('templates/footer');
    }
    ...
    public function chart()
    {
        ...
        $data['title'] = 'Grafik Promosi dan Pemberdayaan Masyarakat';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('ppm/chart');
        $this->load->view('templates/footer');
    }
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('ppm/changepassword', $data);
            $this->load->view('templates/footer');
        } else {
