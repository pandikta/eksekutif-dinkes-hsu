...
class Kefarmasian extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Masukkan Data Kefarmasian, Alkes dan PKRT';
            $this->load->view('templates/header', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('kefarmasian/index');
    ...
    {
        $this->db->delete('kefarmasian', ['id' => $id]);
        $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Data berhasil di hapus!</div>');
        redirect('kefarmasian/table');
    }
    ...
    public function table()
    {
        ...
        $data['title'] = 'Data Kefarmasian, Alkes dan PKRT';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('kefarmasian/table');
        $this->load->view('templates/footer');
    }
    ...
    public function chart()
    {
        ...
        $data['title'] = 'Grafik Kefarmasian, Alkes dan PKRT';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('kefarmasian/chart');
        $this->load->view('templates/footer');
    }
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('kefarmasian/changepassword', $data);
            $this->load->view('templates/footer');
        } else {
            ...
            if (!password_verify($current_password, $data['user']['password'])) {
                ...
                redirect('kefarmasian/changepassword');
            } else {
