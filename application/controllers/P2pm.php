...
class P2pm extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Masukkan Data Pencegahan dan Pengendalian Penyakit Menular';
            $this->load->view('templates/header', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('p2pm/index');
    ...
    {
        $tahun = $this->input->post('tahun');
        $this->db->delete('p2pm', ['tahun' => $tahun]);
    ...
    public function table()
    {
        ...
        $data['title'] = 'Data Pencegahan dan Pengendalian Penyakit Menular';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('p2pm/table');
        $this->load->view('templates/footer');
    }
    ...
    public function chart()
    {
        ...
        $data['title'] = 'Grafik Pencegahan dan Pengendalian Penyakit Menular';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('p2pm/chart');
        $this->load->view('templates/footer');
    }
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('p2pm/changepassword', $data);
            $this->load->view('templates/footer');
        } else {
