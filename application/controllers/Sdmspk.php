...
class Sdmspk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Masukkan Data Sumber Daya manusia dan Sarana Prasarana Kesehatan';
            $this->load->view('templates/header', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('sdmspk/index');
            ...
            foreach ($indikator as $i) {
                ...
                $index++;
                $this->db->insert('sdmspk', $data);
            }

            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data berhasil ditambahkan!</div>');
            redirect('sdmspk'); //lari ke folder menu lalu ke file submenu yg ada di views
    ...
    public function table()
    {
        ...
        $data['title'] = 'Data Sumber Daya manusia dan Sarana Prasarana Kesehatan';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('sdmspk/table');
        $this->load->view('templates/footer');
    }
    ...
    public function chart()
    {
        ...
        $data['title'] = 'Grafik Sumber Daya manusia dan Sarana Prasarana Kesehatan';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('sdmspk/chart');
        $this->load->view('templates/footer');
    }
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('sdmspk/changepassword', $data);
            $this->load->view('templates/footer');
        } else {
            ...
            if (!password_verify($current_password, $data['user']['password'])) {
                ...
                redirect('sdmspk/changepassword');
            } else {
