...
class Kkko extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Masukkan Data Kesling, Kesehatan Kerja dan Olahraga';
            $this->load->view('templates/header', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('kkko/index');
            ...
            foreach ($indikator as $i) {
                ...
                $index++;
                $this->db->insert('kkko', $data);
            }

            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data Berhasil Ditambahkan</div>');
            redirect('kkko'); //lari ke folder menu lalu ke file submenu yg ada di views
    ...
    {
        $tahun = $this->input->post('tahun');
        $this->db->delete('kkko', ['tahun' => $tahun]);
    ...
    public function table()
    {
        ...
        $data['title'] = 'Data Kesling, Kesehatan Kerja dan Olahraga';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('kkko/table');
        $this->load->view('templates/footer');
    }
    ...
    public function chart()
    {
        ...
        $data['title'] = 'Grafik Kesling, Kesehatan Kerja dan Olahraga';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('kkko/chart');
        $this->load->view('templates/footer');
    }
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('kkko/changepassword', $data);
            $this->load->view('templates/footer');
        } else {
