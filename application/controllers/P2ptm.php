...
class P2ptm extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Masukkan Data Pencegahan dan Pengendalian Penyakit Tidak Menular';
            $this->load->view('templates/header', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('p2ptm/index');
            ...
            foreach ($indikator as $i) {
                ...
                $index++;
                $this->db->insert('p2ptm', $data);
            }

            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data berhasil ditambahkan!</div>');
            redirect('p2ptm'); //lari ke folder menu lalu ke file submenu yg ada di views
    ...
    public function table()
    {
        ...
        $data['title'] = 'Data Pencegahan dan Pengendalian Penyakit Tidak Menular';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('p2ptm/table');
        $this->load->view('templates/footer');
    }
    ...
    public function chart()
    {
        ...
        $data['title'] = 'Grafik Pencegahan dan Pengendalian Penyakit Tidak Menular';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('p2ptm/chart');
        $this->load->view('templates/footer');
    }
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('p2ptm/changepassword', $data);
            $this->load->view('templates/footer');
        } else {
