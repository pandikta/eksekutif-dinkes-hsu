...
class Yankes extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Masukkan Data Yankes';
            $this->load->view('templates/header', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('yankes/index');
            ...
            foreach ($indikator as $i) {
                ...
                $index++;
                $this->db->insert('yankes', $data);
            }

            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data berhasil ditambahkan</div>');
            redirect('yankes'); //lari ke folder menu lalu ke file submenu yg ada di views
    ...
    public function table()
    {
        ...
        $data['title'] = 'Data YANKES';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('yankes/table');
        $this->load->view('templates/footer');
    }
    ...
    public function chart()
    {
        ...
        $data['title'] = 'Grafik YANKES';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('yankes/chart');
        $this->load->view('templates/footer');
    }
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('yankes/changepassword', $data);
            $this->load->view('templates/footer');
        } else {
            ...
            if (!password_verify($current_password, $data['user']['password'])) {
                ...
                redirect('yankes/changepassword');
            } else {
