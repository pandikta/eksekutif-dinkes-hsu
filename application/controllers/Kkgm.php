...
class Kkgm extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Masukkan Data Kesehatan Keluarga dan Gizi Masyarakat';
            $this->load->view('templates/header', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('kkgm/index');
            ...
            foreach ($indikator as $i) {
                ...
                $index++;
                $this->db->insert('kkgm', $data);
            }

            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data berhasil ditambahkan!</div>');
            redirect('kkgm'); //lari ke folder menu lalu ke file submenu yg ada di views
    ...
    {
        $tahun = $this->input->post('tahun');
        $this->db->delete('kkgm', ['tahun' => $tahun]);
    ...
    public function table()
    {
        ...
        $data['title'] = 'Data Kesehatan Keluarga dan Gizi Masyarakat';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('kkgm/table');
        $this->load->view('templates/footer');
    }
    ...
    public function chart()
    {
        ...
        $data['title'] = 'Grafik Kesehatan Keluarga dan Gizi Masyarakat';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('kkgm/chart');
        $this->load->view('templates/footer');
    }
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('kkgm/changepassword', $data);
            $this->load->view('templates/footer');
        } else {
