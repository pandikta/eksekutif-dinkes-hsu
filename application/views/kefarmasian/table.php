...
<div class="container-fluid">
    ...
    <div class="col-lg-5">
        <a href="<?= base_url('kefarmasian') ?>" class="btn btn-primary">Tambah Data Baru</a>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" cellspacing="0" style="max-width:100%; white-space:nowrap;">
                    <thead>
                        <tr>
                        ...
                        <?php foreach ($table as $t) :
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('kefarmasian/deletedatabyid/') . $t['id']; ?>" class="badge badge-pill badge-danger" onclick="return confirm('Anda yakin ingin menghapusnya ?')"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url('kefarmasian/deleteDataByYear/'); ?>" method="post">
        ...
        <div class="modal fade" id="editModal<?= $t['id']; ?>" role="dialog" aria-labelledby="editModalLabel<?= $t['id']; ?>" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- base url mengarah ke folder admin lalu ke file role -->
                        <form action="<?= base_url('kefarmasian/edit/' . $t['id']); ?>" method="post">
