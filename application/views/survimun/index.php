...
<div class="container-fluid">
    ...
    <button type="button" name="add" id="add" class="btn btn-success">Tambahkan lebih</button>
    <p>*form harus diisi semua<br>*Jika terdapat data kosong maka masukkan data dengan angka 0</p>

    <form id="forminput" action="<?= base_url('survimun/index'); ?>" method="post">
