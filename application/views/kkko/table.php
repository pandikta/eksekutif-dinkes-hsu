...
<div class="container-fluid">
    ...
    <div class="col-lg-5">
        <a href="<?= base_url('kkko') ?>" class="btn btn-primary">Tambah Data Baru</a>
                        ...
                        <?php foreach ($table as $t) :
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('kkko/deletedatabyid/') . $t['id']; ?>" class="badge badge-pill badge-danger" onclick="return confirm('Anda yakin ingin menghapusnya ?')"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url('kkko/deleteDataByYear/'); ?>" method="post">
        ...
        <div class="modal fade" id="editModal<?= $t['id']; ?>" role="dialog" aria-labelledby="editModalLabel<?= $t['id']; ?>" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- base url mengarah ke folder admin lalu ke file role -->
                        <form action="<?= base_url('kkko/edit/' . $t['id']); ?>" method="post">
