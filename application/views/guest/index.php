...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Guest</h1>
        ...
        <div class="col-xl-8 col-lg-7 al">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Grafik Kefarmasian, Alkes dan PKRT</h6>
                </div>
                <div class="card-body">
                    <?php
...
((bulan_1 + bulan_2 + bulan_3 + bulan_4 + bulan_5 + bulan_6 + bulan_7 + bulan_8 + bulan_9 + bulan_10 + bulan_11 + bulan_12)/sasaran)*(100/100) as persentasi');
                    ...
                    $Chartpencapain = $this->db->get('kefarmasian')->result();
